...
Each value is a string representing an exact real algebraic constant in Z3's
SMT-LIB rational or root-obj syntax: a univariate integer polynomial and ordered
real-root index. No free variables or unevaluated arithmetic terms are accepted.
